...
import com.ssba.savvy_savings_app.databinding.ActivityExpenseEntryBinding
import com.ssba.savvy_savings_app.entities.Expense
import com.ssba.savvy_savings_app.entities.ExpenseCategory
import com.ssba.savvy_savings_app.helpers.SupabaseUtils
import com.ssba.savvy_savings_app.models.ExpenseEntryViewModel
...
class ExpenseEntryActivity : AppCompatActivity() {
    ...
    private lateinit var expenseDao: com.ssba.savvy_savings_app.daos.ExpenseDao
    private lateinit var categoryDao: com.ssba.savvy_savings_app.daos.ExpenseCategoryDao
