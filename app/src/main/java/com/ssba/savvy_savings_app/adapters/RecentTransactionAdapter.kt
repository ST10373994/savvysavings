    ...
    override fun onBindViewHolder(holder: TransactionViewHolder, position: Int) {
        ...
        when (transaction)
        {
            is Expense -> {
                ...
                holder.tvAmount.setTextColor(holder.itemView.context.getColor(R.color.expense_neon))
            }
            is Income -> {
                ...
                holder.tvAmount.text = currencyFormat.format(transaction.amount)
                holder.tvAmount.setTextColor(holder.itemView.context.getColor(R.color.income_neon))
            }
        }
    }
