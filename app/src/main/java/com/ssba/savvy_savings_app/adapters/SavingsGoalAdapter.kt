...
import com.ssba.savvy_savings_app.SavingsGoalActivity
...
/*
 	...
 	* Date Accessed: 30 December 2025
    ...
    RecyclerView.Adapter<SavingsGoalAdapter.SavingsGoalViewHolder>()
{
    ...
    override fun onBindViewHolder(holder: SavingsGoalAdapter.SavingsGoalViewHolder, position: Int)
    {
        ...
        if (goal.endDate.before(Date())) {
            holder.tvEndDate.setTextColor(ContextCompat.getColor(context, R.color.expense_neon))
        }
        ...
        CoroutineScope(Dispatchers.Main).launch {
            ...
            if (progressPercentage >= 100.0) {
                holder.tvProgressPercentage.setTextColor(ContextCompat.getColor(context, R.color.income_neon))
            }
        }
